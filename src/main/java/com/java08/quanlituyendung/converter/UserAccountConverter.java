...
public class UserAccountConverter {
    ...
    public UserInfoEntity toEntity(ProfileUpdateRequestDTO profileUpdateRequest, UserAccountEntity userAccount) {
        ...
        if(profileUpdateRequest.getCvFile() != null){
            userInfoEntity.setCvFile(profileUpdateRequest.getCvFile());
        }
    ...
    public UserAccountEntity toEntityWithAuthProvider(OAuth2RequestDTO oAuth2RequestDTO, Role roleEnum,
            AuthenticationProvider authenticationProvider) {
        UserAccountEntity entity = new UserAccountEntity();
...
//        responseDTO.setAvatar(userAccount.getUserInfo().getAvatar()); doi sau reset d
